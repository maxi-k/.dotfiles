...
(doom! :input
       ...
       golden-ratio        ; golden-ratio-mode for automatic split sizing
       ...
       ;; org-appear       ; make link definitions expand when you hover over them
       ...
       additional-themes   ; load modus themes and more

       :editor
       (evil +everywhere)  ; come to the dark side, we have cookies
       evil-cleverparens   ; clever parenthesis in lisp-like modes with evil
       ...
       (lsp +peek)         ; support the language server protocol
